(function ($) {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        elementorFrontend.hooks.addAction(
            'frontend/element_ready/zupet-counter.default',
            initWidgetThree
        );
	...
	*/
	...
	$(".service-list .lists .item").hover(function(){
		var index = $(this).index() + 1;
		$(".image-box .service-two-image").css("z-index", -1);
		$(".image-box .service-two-image-" + index).css("z-index", 1);
	});
