...
class Protine_OCDI_Demo_Importer {
    ...
    public function __construct() {
        ...
        add_action( 'init', [$this, 'protine_ocdi_rewrite_flush'] );
    }

    public function import_files_config() {

		$home_prevs = array(
			'protine_demo_home_1' => array(
				'title' => __( 'Home 1', 'protinecore' ),
				'page'  => __( 'home-1', 'protinecore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home-1.png', dirname(__FILE__) ),
				'preview_link' => 'https://wp-protine.bugfinder.app/',
			),
			'protine_demo_home_2' => array(
				'title' => __( 'Home 2', 'protinecore' ),
				'page'  => __( 'home-2', 'protinecore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home-2.png', dirname(__FILE__) ),
				'preview_link' => 'https://wp-protine.bugfinder.app/home-2/',
			),
            'protine_demo_home_3' => array(
                'title' => __( 'Home 3', 'protinecore' ),
                'page'  => __( 'home-3', 'protinecore' ),
                'screenshot' => plugins_url( 'assets/img/demo/home-3.png', dirname(__FILE__) ),
                'preview_link' => 'https://wp-protine.bugfinder.app/home-3/',
            ),
		);
        ...
        foreach ( $home_prevs as $key => $prev ) {
            ...
            $config[] = [
                ...
                'import_notice'                => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'protinecore' ),
            ];
        }
    ...
    public function protine_ocdi_rewrite_flush() {
...
new Protine_OCDI_Demo_Importer;