...
class Raizen_OCDI_Demo_Importer {
    ...
    public function __construct() {
        ...
        add_action( 'init', [$this, 'raizen_ocdi_rewrite_flush'] );
    }

    public function import_files_config() {

		$home_prevs = array(
			'raizen_demo_home_1' => array(
				'title' => __( 'Home 1', 'raizencore' ),
				'page'  => __( 'home-1', 'raizencore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home-1.png', dirname(__FILE__) ),
				'preview_link' => 'https://wp-raizen.bugfinder.app/',
			),
			'raizen_demo_home_2' => array(
				'title' => __( 'Home 2', 'raizencore' ),
				'page'  => __( 'home-2', 'raizencore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home-2.png', dirname(__FILE__) ),
				'preview_link' => 'https://wp-raizen.bugfinder.app/home-2/',
			),
            'raizen_demo_home_3' => array(
                'title' => __( 'Home 3', 'raizencore' ),
                'page'  => __( 'home-3', 'raizencore' ),
                'screenshot' => plugins_url( 'assets/img/demo/home-3.png', dirname(__FILE__) ),
                'preview_link' => 'https://wp-raizen.bugfinder.app/home-3/',
            ),
		);
        ...
        foreach ( $home_prevs as $key => $prev ) {
            ...
            $config[] = [
                ...
                'import_notice'                => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'raizencore' ),
            ];
        }
    ...
    public function raizen_ocdi_rewrite_flush() {
