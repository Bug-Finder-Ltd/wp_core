...
class Zupet_OCDI_Demo_Importer {
    ...
    public function __construct() {
        ...
        add_action( 'init', [$this, 'zupet_ocdi_rewrite_flush'] );
    }

    public function import_files_config() {

		$home_prevs = array(
			'zupet_demo_home_1' => array(
				'title' => __( 'Home 1', 'zupetcore' ),
				'page'  => __( 'home-1', 'zupetcore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home-1.png', dirname(__FILE__) ),
				'preview_link' => 'https://wp-zupet.bugfinder.app/',
			),
			'zupet_demo_home_2' => array(
				'title' => __( 'Home 2', 'zupetcore' ),
				'page'  => __( 'home-2', 'zupetcore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home-2.png', dirname(__FILE__) ),
				'preview_link' => 'https://wp-zupet.bugfinder.app/home-2/',
			),
		);
        ...
        foreach ( $home_prevs as $key => $prev ) {
            ...
            $config[] = [
                ...
                'import_notice'                => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'zupetcore' ),
            ];
        }
    ...
    public function zupet_ocdi_rewrite_flush() {
