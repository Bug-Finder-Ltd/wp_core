...
class Bwall_OCDI_Demo_Importer {
    ...
    public function __construct() {
        ...
        add_action( 'init', [$this, 'bwall_ocdi_rewrite_flush'] );
    }

    public function import_files_config() {

		$home_prevs = array(
			'bwall_demo_home_1' => array(
				'title' => __( 'Home 1', 'bwallcore' ),
				'page'  => __( 'home', 'bwallcore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home-1.jpg', dirname(__FILE__) ),
				'preview_link' => 'https://wp-bwall.bugfinder.app/',
			),
			'bwall_demo_home_2' => array(
				'title' => __( 'Home 2', 'bwallcore' ),
				'page'  => __( 'home-2', 'bwallcore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home-2.jpg', dirname(__FILE__) ),
				'preview_link' => 'https://wp-bwall.bugfinder.app/home-02/',
			),
		);

        $config = [];

        $import_path = trailingslashit( BWALL_ADDONS_PATH ) . 'admin/demo-data/';;
        ...
        foreach ( $home_prevs as $key => $prev ) {
            ...
            $config[] = [
                ...
                'import_notice'                => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'bwallcore' ),
            ];
        }
    ...
    public function bwall_ocdi_rewrite_flush() {
