 ...
 * @since 1.0.0
 */
class Zupet_List extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		<?php if ( $settings['zupet_design_style']  == 'layout-1' ): ?>
			...
			<ul class="lists style-1">
				<?php foreach (  $settings['zupet_list_slides'] as $item ) { ?>
					<li>
...
$widgets_manager->register( new Zupet_List() );