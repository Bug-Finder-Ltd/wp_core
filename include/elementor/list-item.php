 ...
 * @since 1.0.0
 */
class Protine_List extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		 ...
		 */
		$this->start_controls_section(
            'protine_list_section',
            [
                'label' => __( 'List Item', 'protinecore' ),
	...
	protected function render() {
		...
		<?php if ( $settings['protine_design_style']  == 'layout-1' ): ?>
			...
			<ul class="lists style-1">
				<?php foreach (  $settings['protine_list_slides'] as $item ) { ?>
					<li>
...
$widgets_manager->register( new Protine_List() );