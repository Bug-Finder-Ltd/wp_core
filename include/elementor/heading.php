 ...
 * @since 1.0.0
 */
class Provix_Heading extends \Elementor\Widget_Base {

	public function get_name() {
		return 'provix-heading';
	}

	public function get_title() {
		return __( 'Heading', 'agenvix-core' );
	}
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => \Elementor\Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .heading-text .heading span' => 'color: {{VALUE}}',
                    ],
                ]
            );
        $this->end_controls_section();
...
$widgets_manager->register( new Provix_Heading() );