 ...
 * @since 1.0.0
 */
class Raizen_Skill_List extends \Elementor\Widget_Base {

	public function get_name() {
		return 'raizen-skill-list';
	}

	public function get_title() {
		return __( 'Skill List', 'raizencore' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'skills_section',
            [
                'label' => esc_html__( 'Skills', 'raizencore' ),
        ...
        $repeater->add_control(
            'skill_name',
            [
                'label' => esc_html__( 'Skill Name', 'raizencore' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'Figma' , 'raizencore' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'progress_lavel',
            [
                'label' => esc_html__( 'Progress', 'raizencore' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( '50%' , 'raizencore' ),
            ]
        );
        ...
        $this->add_control(
            'list',
            [
                'label' => esc_html__( 'Skill List', 'raizencore' ),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'skill_name' => esc_html__( 'Figma', 'raizencore' ),
                    ],
                    [
                        'skill_name' => esc_html__( 'Photoshop', 'raizencore' ),
                    ],
                ],
        ...
        $this->start_controls_section(
            'item_style',
            [
                'label' => esc_html__( 'Item', 'raizencore' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
	...
	protected function render() {
        ...
        <div class="skill-list style-two">
            ...
            foreach (  $settings['list'] as $item ) :
                ...
                ?>
                <div class="skill-item wow fadeInLeft" data-wow-delay="<?php echo $ms_delay; ?>ms">
                    <div class="icon">
                        <img src="<?php echo esc_url($icon); ?>" alt="icon">
                    </div>
                    <h5 class="name">
...
$widgets_manager->register( new Raizen_Skill_List() );