 ...
 * @since 1.0.0
 */
class Raizen_CTA_Area extends \Elementor\Widget_Base {

	public function get_name() {
		return 'raizen-cta-area';
	}

	public function get_title() {
		return __( 'CTA Area', 'raizencore' );
	}
	...
	protected function render() {
		...
		<?php elseif( $settings['raizen_design_style']  == 'layout-2' ): ?>
            ...
            <div class="section-subtitle style-one <?php echo $settings['text_alignment']; ?>">
                <h2 class="subtitle">
                    <span><?php echo $settings['raizen_subtitle']; ?></span>
                </h2>
            </div>
...
$widgets_manager->register( new Raizen_CTA_Area() );