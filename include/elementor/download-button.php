 ...
 * @since 1.0.0
 */
class Zupet_Download_Button extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Download Button', 'zupetcore' );
	}
                                        ...
                                        <div class="about-round-text">
                                            <div class="round-box-content">
                                                ...
                                                <div class="round-box-icon">
                                                    <a href="<?php echo esc_url($settings['zupet_page_link']); ?>"><img src="<?php echo get_template_directory_uri() .  '/assets/img/icons/arrow-big-black.png';?>" alt="arrow"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
$widgets_manager->register( new Zupet_Download_Button() );