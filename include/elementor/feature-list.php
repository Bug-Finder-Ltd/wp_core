 ...
 * @since 1.0.0
 */
class Raizen_Feature_List extends \Elementor\Widget_Base {

	public function get_name() {
		return 'raizen-feature-list';
	}

	public function get_title() {
		return __( 'Feature List', 'raizencore' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'features',
            [
                'label' => esc_html__( 'Features', 'raizencore' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'type' => \Elementor\Controls_Manager::TEXT,
                    'default' => esc_html__( '01' , 'raizencore' ),
                ]
            );
            ...
            $repeater->add_control(
                ...
                [
                    'label' => esc_html__( 'Content', 'raizencore' ),
                    'type' => \Elementor\Controls_Manager::TEXTAREA,
                    'default' => esc_html__( 'List Content' , 'raizencore' ),
                    'show_label' => false,
                ]
            );
            $repeater->add_control(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'list_title' => esc_html__( 'Title #1', 'raizencore' ),
                            'list_content' => esc_html__( 'Item content. Click the edit button to change this text.', 'raizencore' ),
                        ],
                        [
                            'list_title' => esc_html__( 'Title #2', 'raizencore' ),
                            'list_content' => esc_html__( 'Item content. Click the edit button to change this text.', 'raizencore' ),
                        ],
                    ],
...
$widgets_manager->register( new Raizen_Feature_List() );