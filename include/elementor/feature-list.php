 ...
 * @since 1.0.0
 */
class Protine_Feature_List extends \Elementor\Widget_Base {

	public function get_name() {
		return 'protine-feature-list';
	}

	public function get_title() {
		return __( 'Feature List', 'protinecore' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'features',
            [
                'label' => esc_html__( 'Features', 'protinecore' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
            ...
            $repeater->add_control(
                ...
                [
                    'label' => esc_html__( 'Content', 'protinecore' ),
                    'type' => \Elementor\Controls_Manager::TEXTAREA,
                    'default' => esc_html__( 'List Content' , 'protinecore' ),
                    'show_label' => false,
                ]
            );
            $repeater->add_control(
                'icon_image',
                [
                    'label' => esc_html__( 'Choose Icon', 'protinecore' ),
                ...
                [
                    ...
                    'default' => [
                        [
                            ...
                            'list_content' => esc_html__( 'Item content. Click the edit button to change this text.', 'protinecore' ),
                        ],
                        [
...
$widgets_manager->register( new Protine_Feature_List() );