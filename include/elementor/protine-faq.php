 ...
 * @since 1.0.0
 */
class Protine_Faq extends Widget_Base {
	...
	public function get_title() {
		return __( 'FAQ / Your Answer', 'protinecore' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'protine_client_box_text',
            [
                'label' => esc_html__('Client Box Text', 'protinecore'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('100+ Happy Clients  ', 'protinecore'),
                'title' => esc_html__('Enter client box text', 'protinecore'),
                'label_block' => true,
            ]
        );
		...
		$this->start_controls_section(
            '_accordion',
            [
                'label' => esc_html__( 'Accordion', 'protinecore' ),
        ...
        $repeater->add_control(
            'accordion_title', [
                'label' => esc_html__( 'Accordion Item', 'protinecore' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'This is accordion item title' , 'protinecore' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => __( 'Accordion Color', 'protinecore' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'accordions',
            [
                'label' => esc_html__( 'Repeater Accordion', 'protinecore' ),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'accordion_title' => esc_html__( 'Credibly initiate efficient e-commerce whereas services?', 'protinecore' ),
                    ],
                    [
                        'accordion_title' => esc_html__( 'How Much Does Protine Monthly Cost?', 'protinecore' ),
                    ],
                    [
                        'accordion_title' => esc_html__( 'What Payment Method do you Supports?', 'protinecore' ),
                    ]
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Accordion space gap', 'protinecore' ),
	...
	protected function render() {
        ...
        <?php if ( $settings['protine_design_style']  == 'layout-2' ):
            if ( !empty($settings['protine_faq_image']['url']) ) {
                $protine_faq_image = !empty($settings['protine_faq_image']['id']) ? wp_get_attachment_image_url( $settings['protine_faq_image']['id'], $settings['protine_image_size_size']) : $settings['protine_faq_image']['url'];
                $protine_faq_image_alt = get_post_meta($settings["protine_faq_image"]["id"], "_wp_attachment_image_alt", true);
            }
            if ( !empty($settings['protine_faq_image_2']['url']) ) {
                $protine_faq_image_2 = !empty($settings['protine_faq_image_2']['id']) ? wp_get_attachment_image_url( $settings['protine_faq_image_2']['id'], $settings['protine_image_size_size']) : $settings['protine_faq_image_2']['url'];
                $protine_faq_image_2_alt = get_post_meta($settings["protine_faq_image_2"]["id"], "_wp_attachment_image_alt", true);
            }
        ?>
            <!-- faq -->
            <section class="faq">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapse<?php echo esc_attr($index);?>" class="accordion-collapse collapse <?php echo esc_attr($show); ?>" aria-label="heading<?php echo esc_attr($index);?>" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p><?php echo protine_kses($item['accordion_description']); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>                                    
                        ...
                        <div class="col-xl-5 offset-xl-1 col-lg-6">
                            <div class="faq-right-container">
                                ...
                                <div class="faq-image-1">
                                    <?php if ($settings['protine_faq_image']['url'] || $settings['protine_faq_image']['id']) : ?>
                                        <img src="<?php echo esc_url($protine_faq_image); ?>" alt="<?php echo esc_attr($protine_faq_image_alt); ?>">
                                    <?php endif; ?>
                                </div>
                                <div class="faq-image-2">
                                    <?php if ($settings['protine_faq_image_2']['url'] || $settings['protine_faq_image_2']['id']) : ?>
                                        <img src="<?php echo esc_url($protine_faq_image_2); ?>" alt="<?php echo esc_attr($protine_faq_image_2_alt); ?>">
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="faq-client-box">
                                    ...
                                    <?php if ( !empty($settings['protine_client_box_text']) ) : ?>
                                        <p><?php echo protine_kses( $settings['protine_client_box_text'] ); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                ...
                <ul class="accordion-box acc_style_h4">
                    ...
                    <li class="accordion block <?php echo $index === 0 ? 'active-block' : ''; ?>">
                        ...
                        <div class="acc-content <?php echo $index === 0 ? 'current' : ''; ?>">
                            <p class="text"><?php echo protine_kses($item['accordion_description']); ?></p>
                        </div>
                    </li>
                    <?php endforeach; ?>
                </ul>
...
$widgets_manager->register( new Protine_Faq() );