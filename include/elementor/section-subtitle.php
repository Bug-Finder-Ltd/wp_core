 ...
 * @since 1.0.0
 */
class Zupet_Section_Subtitle extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Section Subtitle', 'zupetcore' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Subtitle Here', 'zupetcore'),
                'placeholder' => esc_html__('Type subtitle', 'zupetcore'),
                'label_block' => true,
            ]
        );
	...
	protected function render() {
		...
		<?php if ( $settings['zupet_design_style']  == 'layout-2' ): ?>
            ...
            <div class="section-subtitle style-two <?php echo $settings['text_alignment']; ?>">
                <h2 class="subtitle"><?php echo $settings['zupet_subtitle']; ?></h2>
            </div>
...
$widgets_manager->register( new Zupet_Section_Subtitle() );