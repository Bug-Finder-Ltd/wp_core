 ...
 * @since 1.0.0
 */
class Protine_Why_Choose_Us extends Widget_Base {
	...
	public function get_title() {
		return __( 'Why Choose Us', 'protinecore' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'protine_count_value',
            [
                'label' => esc_html__('Count Value', 'protinecore'),
                'description' => protine_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('12', 'protinecore'),
                'placeholder' => esc_html__('Type count value', 'protinecore'),
                'label_block' => true,
            ]
        );
        
        $this->add_control(
            'protine_count_value_color',
            [
                'label' => __( 'Count Value Color', 'protinecore' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'protine_count_value_post_text',
            [
                'label' => esc_html__('Count Value Post Text', 'protinecore'),
                'description' => protine_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('K+', 'protinecore'),
                'placeholder' => esc_html__('Type count value post text', 'protinecore'),
                'label_block' => true,
            ]
        );
        
        $this->add_control(
            'protine_count_value_post_text_color',
            [
                'label' => __( 'Count Value Post Text Color', 'protinecore' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'protine_counter_text',
            [
                'label' => esc_html__('Counter Text', 'protinecore'),
                'description' => protine_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Counter Text Here', 'protinecore'),
                'placeholder' => esc_html__('Type Counter Text', 'protinecore'),
                'label_block' => true,
            ]
        );
        
        $this->add_control(
            'protine_counter_text_color',
            [
                'label' => __( 'Counter Text Color', 'protinecore' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $repeater->add_control(
            'protine_features_text', [
                'label' => esc_html__('Features Description', 'protinecore'),
                'description' => protine_get_allowed_html_desc( 'basic' ),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Ntypesetting industry Loreaim Ipsum has been in our the design compan industry compan standard dummy Lorem Ipsum', 'protinecore'),
                'label_block' => true,
            ]
        );

        $repeater->add_control(
            'protine_features_text_color',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'protine_features_title' => esc_html__('Organizational Design', 'protinecore'),
                    ],
                    [
                        'protine_features_title' => esc_html__('Digital Transformation', 'protinecore')
                    ]
                ],
         ...
         */
        $this->start_controls_section(
            'protine_progress_bar',
            [
                'label' => esc_html__('Skill Bar', 'protinecore'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Design', 'protinecore' ),
                'placeholder' => esc_html__( 'Type a skill name', 'protinecore' ),
            ]
        );
        ...
        $repeater->add_control(
            'level',
            [
                'label' => esc_html__( 'Level (Out Of 100)', 'protinecore' ),
        ...
        $repeater->add_control(
            'want_customize',
            [
                'label' => esc_html__( 'Want To Customize?', 'protinecore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'protinecore' ),
                'label_off' => esc_html__( 'No', 'protinecore' ),
                'return_value' => 'yes',
                'description' => esc_html__( 'You can customize this skill bar color from here or customize from Style tab', 'protinecore' ),
                'style_transfer' => true,
            ]
        );
        ...
        $repeater->add_control(
            'title_color',
            [
                'label' => esc_html__( 'Title Color', 'protinecore' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $repeater->add_control(
            'percentage_color',
            [
                'label' => esc_html__( 'Percentage label Color', 'protinecore' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $repeater->add_group_control(
            Group_Control_ProtineBGGradient::get_type(),
            [
                'name' => 'level_color',
                'label' => esc_html__('Level Color', 'protinecore'),
        ...
        $repeater->add_control(
            'base_color',
            [
                'label' => esc_html__( 'Base Color', 'protinecore' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'protine_image_2',
            [
                'label' => esc_html__( 'Image 2', 'protinecore' ),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],
        ...
        $this->add_control(
            'protine_image_3',
            [
                'label' => esc_html__( 'Image 3', 'protinecore' ),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],
	...
	protected function render() {
		...
		<?php 
            ...
            if ( !empty($settings['protine_image_3']['url']) ) {
                $protine_image_3 = !empty($settings['protine_image_3']['id']) ? wp_get_attachment_image_url( $settings['protine_image_3']['id'], $settings['protine_image_size_size']) : $settings['protine_image_3']['url'];
                $protine_image_3_alt = get_post_meta($settings["protine_image_3"]["id"], "_wp_attachment_image_alt", true);
            }     
        ?>	
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="choose-left-container">
                            <div class="choose-image-1">
                                <img src="<?php echo esc_url($protine_image); ?>" alt="<?php echo esc_url($protine_image_alt); ?>">
                            </div>
                            <div class="choose-image-2 mt_50">
                                <img src="<?php echo esc_url($protine_image_2); ?>" alt="<?php echo esc_url($protine_image_2_alt); ?>">
                            </div>
                            <div class="choose-image-3">
                                <img src="<?php echo esc_url($protine_image_3); ?>" alt="<?php echo esc_url($protine_image_3_alt); ?>">
                                <div class="choose-counter">
                                    <div class="odometer-box">
                                        <h5 class="odometer" data-count="<?php echo protine_kses( $settings['protine_count_value'] ); ?>">00</h5>
                                        <div class="odometer-text"><?php echo protine_kses( $settings['protine_count_value_post_text'] ); ?></div>
                                    </div>
                                    <?php if ( !empty($settings['protine_counter_text']) ) : ?>    
                                        <p><?php echo protine_kses( $settings['protine_counter_text'] ); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="choose-right-container">
                            <div class="choose-right-btn-box">
                                ...
                                <div class="choose-right-round-btn">
                                    <?php if ( ! empty( $settings['protine_show_all_btn_link']['url'] ) ) : ?>
                                        <a href="<?php echo esc_url($settings['protine_show_all_btn_link']['url'] ); ?>" class="round-btn"><p><?php echo protine_kses( $settings['protine_show_all_btn_text'] ); ?></p> <i class="icon-arrow-1"></i> <span></span></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <?php foreach ($settings['protine_features_list'] as $key => $item) : ?>
                                <div class="choose-right-content">
                                    <h5><?php echo protine_kses($item['protine_features_title' ]); ?></h5>
                                    <p><?php echo protine_kses($item['protine_features_text' ]); ?></p>
                                </div>
                            <?php endforeach; ?>
...
$widgets_manager->register( new Protine_Why_Choose_Us() );