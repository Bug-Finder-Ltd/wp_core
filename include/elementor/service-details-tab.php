...
class Service_Details_Tab extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Service Details Tab', 'agenvix-core' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('About', 'agenvix-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Service description here', 'agenvix-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title', 'agenvix-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Includes', 'agenvix-core'),
                'placeholder' => esc_html__('Type title', 'agenvix-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title', 'agenvix-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Benefits', 'agenvix-core'),
                'placeholder' => esc_html__('Type title', 'agenvix-core'),
                'label_block' => true,
            ]
        );
