...
class Service_Details_Tab extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Service Details Tab', 'raizencore' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('About', 'raizencore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Service description here', 'raizencore'),
                'placeholder' => esc_html__('Type your description here', 'raizencore'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title', 'raizencore'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Includes', 'raizencore'),
                'placeholder' => esc_html__('Type title', 'raizencore'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title', 'raizencore'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Benefits', 'raizencore'),
                'placeholder' => esc_html__('Type title', 'raizencore'),
                'label_block' => true,
            ]
        );
