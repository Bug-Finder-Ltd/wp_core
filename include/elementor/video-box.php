 ...
 * @since 1.0.0
 */
class Zupet_Video_Box extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'video',
            [
                'label' => esc_html__( 'Choose Video', 'zupetcore' ),
                'type' => \Elementor\Controls_Manager::MEDIA,
            ]
        );
        $this->add_control(
	...
	protected function render() {
		...
		<?php if ( $settings['zupet_design_style']  == 'layout-1' ):
            ...
            ?>
                ...
                <div class="video-box overlay-anim style-one">
                    <img src="<?php echo esc_url($settings['image']['url']); ?>" class="preview-image" alt="Preview">
                    <div class="play-button video-play-btn">
                        <?php \Elementor\Icons_Manager::render_icon( $settings['icon'], [ 'aria-hidden' => 'true' ] ); ?>
                    </div>
                    <video id="videoPlayer" controls=""> <source src="<?php echo esc_url($settings['video']['url']); ?>" type="video/webm"></video>
...
$widgets_manager->register( new Zupet_Video_Box() );