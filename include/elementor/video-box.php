 ...
 * @since 1.0.0
 */
class Raizen_Video_Box extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Video Box', 'raizencore' );
	}
		...
		<?php if ( $settings['raizen_design_style']  == 'layout-1' ):
            ...
            ?>
                ...
                <div class="video-box style-one">
                    <video muted loop src="<?php echo esc_url($settings['video']['url']); ?>"></video>
                </div>
...
$widgets_manager->register( new Raizen_Video_Box() );