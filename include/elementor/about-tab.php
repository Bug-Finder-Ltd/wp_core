 ...
 * @since 1.0.0
 */
class Provix_About_Tab extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Tab', 'agenvix-core' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'tab_1',
            [
                'label' => esc_html__('Tab 1', 'agenvix-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Mission', 'agenvix-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Agenvix section description here', 'agenvix-core'),
        ...
        $this->start_controls_section(
            'tab_2',
            [
                'label' => esc_html__('Tab 2', 'agenvix-core'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title', 'agenvix-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Vision', 'agenvix-core'),
                'placeholder' => esc_html__('Type title', 'agenvix-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->start_controls_section(
            'tab_3',
            [
                'label' => esc_html__('Tab 3', 'agenvix-core'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title', 'agenvix-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('History', 'agenvix-core'),
                'placeholder' => esc_html__('Type title', 'agenvix-core'),
                'label_block' => true,
            ]
        );
	...
	protected function render() {
		...
		<?php if ( $settings['provix_design_style']  == 'layout-1' ): 
            ...
            if ( !empty($settings['tab1_image']['url']) ) {
                ...
                $provix_about_left_image_alt = get_post_meta($settings["tab1_image"]["id"], "_wp_attachment_image_alt", true);
            }
            ...
            if ( !empty($settings['tab2_image']['url']) ) {
                ...
                $provix_about_right_image_alt = get_post_meta($settings["tab2_image"]["id"], "_wp_attachment_image_alt", true);
            }
            ...
            if ( !empty($settings['tab3_image']['url']) ) {
                ...
                $provix_about_right_image_alt = get_post_meta($settings["tab3_image"]["id"], "_wp_attachment_image_alt", true);
            }
                                    ...
                                    <div class="about-two-round-text">
                                        <div class="round-box-content">
                                            ...
                                            <div class="round-box-icon">
                                                <a href="<?php echo esc_url($settings['provix_page_link']); ?>"><img src="<?php echo get_template_directory_uri() . '/assets/img/icons/arrow-big-white.png';?>" alt="arrow"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="about-two-right-content">
                                    ...
                                    <div class="about-two-right-image-box">
                                        ...
                                        <div class="about-two-right-image-two">
                                            <?php if ($settings['provix_about_right_image_2']['url'] || $settings['provix_about_right_image_2']['id']) : ?>
                                                <img src="<?php echo esc_url($provix_about_right_image_2); ?>" alt="<?php echo esc_attr($provix_about_right_image_2_alt); ?>">
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="about-two-right-round">
                                            <div class="round-box-content">
                                                <span class="curved-circle-3"><?php echo provix_kses($settings['text_inside_circle']); ?> </span>
                                                <div class="round-box-icon">
                                                    <a class="play_btn hv-popup-link" href="<?php echo esc_url($settings['provix_video_url']); ?>">
...
$widgets_manager->register( new Provix_About_Tab() );