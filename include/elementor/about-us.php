 ...
 * @since 1.0.0
 */
class Protine_About extends Widget_Base {
                                ...
                                <div class="about-two-right-icon">
                                    ...
                                    <div class="about-two-round-text">
                                        <div class="round-box-content">
                                            <span class="curved-circle"><?php echo protine_kses($settings['text_inside_circle']); ?> </span>
                                            <div class="round-box-icon">
                                                <a href="<?php echo esc_url($settings['protine_page_link']); ?>"><img src="<?php echo get_template_directory_uri() . '/assets/img/icons/arrow-big-white.png';?>" alt="arrow"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="about-two-right-content">
                                    ...
                                    <div class="about-two-right-image-box">
                                        ...
                                        <div class="about-two-right-image-two">
                                            <?php if ($settings['protine_about_right_image_2']['url'] || $settings['protine_about_right_image_2']['id']) : ?>
                                                <img src="<?php echo esc_url($protine_about_right_image_2); ?>" alt="<?php echo esc_attr($protine_about_right_image_2_alt); ?>">
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="about-two-right-round">
                                            <div class="round-box-content">
                                                <span class="curved-circle-3"><?php echo protine_kses($settings['text_inside_circle']); ?> </span>
                                                <div class="round-box-icon">
                                                    <a class="play_btn hv-popup-link" href="<?php echo esc_url($settings['protine_video_url']); ?>">
...
$widgets_manager->register( new Protine_About() );