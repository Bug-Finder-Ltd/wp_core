...
class TestimonialBox extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Testimonial Box', 'raizencore' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'review_section',
            [
                'label' => esc_html__( 'Review', 'raizencore' ),
    ...
    ?>
        ...
        <?php if ( $settings['raizen_design_style']  == 'layout-2' ): ?>
            ...
            <div class="testimonial-box style-one">
                <?php
                    if ( !empty($settings['reviewer_image']['url']) ) {
                        $raizen_reviewer_image = !empty($settings['reviewer_image']['id']) ? wp_get_attachment_image_url( $settings['reviewer_image']['id'], '') : $settings['reviewer_image']['url'];
                    }
                ?>
                <div class="single-testimonial">
                    <div class="testi-head">
                        <div class="client-info">
                            ...
                            <?php if(!empty($raizen_reviewer_image)) : ?>
                                <div class="image">
                                    <img src="<?php echo esc_url($raizen_reviewer_image); ?>" alt="image">
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="testi-content">
                        <?php if ( !empty($settings['review_content']) ) : ?>
                            <p><?php echo raizen_kses($settings['review_content']); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
