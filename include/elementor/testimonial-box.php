...
class TestimonialBox extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Testimonial Box', 'zupetcore' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'review_section',
            [
                'label' => esc_html__( 'Review', 'zupetcore' ),
            ...
            <div class="testimonial-box style-one">
                <?php
                    if ( !empty($settings['reviewer_image']['url']) ) {
                        $zupet_reviewer_image = !empty($settings['reviewer_image']['id']) ? wp_get_attachment_image_url( $settings['reviewer_image']['id'], '') : $settings['reviewer_image']['url'];
                    }
                ?>
                <div class="single-testimonial">
                    <div class="testi-head">
                        <div class="client-info">
                            ...
                            <?php if(!empty($zupet_reviewer_image)) : ?>
                                <div class="image">
                                    <img src="<?php echo esc_url($zupet_reviewer_image); ?>" alt="image">
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="testi-content">
                        <?php if ( !empty($settings['review_content']) ) : ?>
                            <p><?php echo zupet_kses($settings['review_content']); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
