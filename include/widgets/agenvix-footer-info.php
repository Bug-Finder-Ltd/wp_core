<?php
	...
	class Provix_Footer_Info  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('provix_footer_info',esc_html__('Provix Footer Info', 'agenvix-core'),array(
				'description' => esc_html__('Provix Footer Info', 'agenvix-core'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Text Content:','agenvix-core'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Provix_Footer_Info');
	});