...
Class Zupet_Blog_Post_Sidebar_Widget extends WP_Widget {

	public function __construct(){
		parent::__construct('zupet-latest-posts', 'Zupet Latest Posts Sidebar', array(
			'description'	=> 'Zupet latest blog post sidebar'
		));
	}
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '3', 'zupetcore' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'zupetcore' );
		$choose_style = ! empty( $instance['choose_style'] ) ? $instance['choose_style'] : esc_html__( 'style_1', 'zupetcore' );
	?>
		<p>
...
add_action('widgets_init', function(){
	register_widget('Zupet_Blog_Post_Sidebar_Widget');
});
