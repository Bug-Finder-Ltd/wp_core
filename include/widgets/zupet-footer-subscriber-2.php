<?php
class Zupet_Footer_Subscriber_2 extends WP_Widget {

    public function __construct() {
        parent::__construct('zupet-footer-subscriber-2', 'Zupet Footer Subscriber 2', array(
			'description'	=> 'Footer subscriber 2 by Zupet'
		));
    }
    ...
    public function form( $instance ) {
        ...
        ?>
			<p><label for="title"><?php esc_html_e( 'Subscribe Form Shortcode:', 'zupetcore' );?></label></p>
...
add_action('widgets_init', function(){
	register_widget('Zupet_Footer_Subscriber_2');
});
