...
Class Latest_Sidebar_Cat_List_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bwall-sidebar-cats-list', 'Bwall Sidebar Category List', array(
			'description'	=> 'Bwall sidebar category list'
		));
	}
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '5', 'bwallcores' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'bwallcores' );
	?>	
		<p>
