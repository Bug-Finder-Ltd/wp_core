...
Class Latest_Sidebar_Cat_List_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('nextdestina-sidebar-cats-list', 'Nextdestina Sidebar Category List', array(
			'description'	=> 'Nextdestina sidebar category list'
		));
	}
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '5', 'nextdestinacores' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'nextdestinacores' );
	?>	
		<p>
