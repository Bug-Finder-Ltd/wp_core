<?php
	...
	class Bwall_Footer_Email  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('bwall_footer_email',esc_html__('Bwall Footer Email', 'bwallcore'),array(
				'description' => esc_html__('Bwall Footer Email', 'bwallcore'),
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Bwall_Footer_Email');
	});