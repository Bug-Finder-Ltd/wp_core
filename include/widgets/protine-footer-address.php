<?php
	...
	class Protine_Footer_Address  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('protine_footer_address',esc_html__('Protine Footer Address', 'protinecore'),array(
				'description' => esc_html__('Protine Footer Address', 'protinecore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Address:','protinecore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Email Address:','protinecore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Phone Number:','protinecore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Protine_Footer_Address');
	});