...
Class Raizen_Blog_Post_Sidebar_Widget extends WP_Widget {

	public function __construct(){
		parent::__construct('raizen-latest-posts', 'Raizen Latest Posts Sidebar', array(
			'description'	=> 'Raizen latest blog post sidebar'
		));
	}
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '3', 'raizencore' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'raizencore' );
		$choose_style = ! empty( $instance['choose_style'] ) ? $instance['choose_style'] : esc_html__( 'style_1', 'raizencore' );
	?>
		<p>
...
add_action('widgets_init', function(){
	register_widget('Raizen_Blog_Post_Sidebar_Widget');
});
