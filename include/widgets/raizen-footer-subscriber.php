<?php
class Raizen_Footer_Subscriber extends WP_Widget {

    public function __construct() {
        parent::__construct('raizen-footer-subscriber', 'Raizen Footer Subscriber', array(
			'description'	=> 'Footer subscriber by Raizen'
		));
    }
    ...
    public function form( $instance ) {
        ...
        ?>
			<p><label for="title"><?php esc_html_e( 'Title:', 'raizencore' );?></label></p>
			...
			<p>
				<label for="title"><?php esc_html_e('Description:','raizencore'); ?></label>
			</p>
...
add_action('widgets_init', function(){
	register_widget('Raizen_Footer_Subscriber');
});
