<?php 
	Class Zupet_Logo_Info_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('zupet-logo-info-footer', 'Zupet Footer Logo Info', array(
				'description'	=> 'Logo Info Widget by Zupet'
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Short Description:','zupetcore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Zupet_Logo_Info_Footer_Widget');
	});