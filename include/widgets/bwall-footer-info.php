<?php
	...
	class Bwall_Footer_Info  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('bwall_footer_info',esc_html__('Bwall Footer Info', 'bwallcore'),array(
				'description' => esc_html__('Bwall Footer Info', 'bwallcore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Text Content:','bwallcore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Bwall_Footer_Info');
	});