<?php 
	Class Zupet_Latest_Posts_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('zupet-latest-posts-footer', 'Zupet Footer Posts', array(
				'description'	=> 'Latest Post Widget by Zupet'
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Zupet_Latest_Posts_Footer_Widget');
	});