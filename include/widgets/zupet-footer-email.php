<?php
	...
	class Zupet_Footer_Email  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('zupet_footer_email',esc_html__('Zupet Footer Email', 'zupetcore'),array(
				'description' => esc_html__('Zupet Footer Email', 'zupetcore'),
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Zupet_Footer_Email');
	});