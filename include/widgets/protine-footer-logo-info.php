<?php 
	Class Protine_Logo_Info_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('protine-logo-info-footer', 'Protine Footer Logo Info', array(
				'description'	=> 'Logo Info Widget by Protine'
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Short Description:','protinecore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Protine_Logo_Info_Footer_Widget');
	});