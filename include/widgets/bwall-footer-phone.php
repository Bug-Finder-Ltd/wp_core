<?php
	...
	class Bwall_Footer_Phone  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('bwall_footer_phone',esc_html__('Bwall Footer Phone', 'bwallcore'),array(
				'description' => esc_html__('Bwall Footer Phone', 'bwallcore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="Phone 1"><?php esc_html_e('Phone Number 1:','bwallcore'); ?></label>
			</p>
			...
			<p>
				<label for="Phone 2"><?php esc_html_e('Phone Number 2:','bwallcore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Bwall_Footer_Phone');
	});