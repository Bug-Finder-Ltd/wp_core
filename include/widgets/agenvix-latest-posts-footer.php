<?php 
	Class Provix_Latest_Posts_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('provix-latest-posts-footer', 'Provix Footer Posts', array(
				'description'	=> 'Latest Post Widget by Provix'
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Provix_Latest_Posts_Footer_Widget');
	});