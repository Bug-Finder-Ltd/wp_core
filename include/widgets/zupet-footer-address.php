<?php
	...
	class Zupet_Footer_Address  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('zupet_footer_address',esc_html__('Zupet Footer Address', 'zupetcore'),array(
				'description' => esc_html__('Zupet Footer Address', 'zupetcore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Address:','zupetcore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Email Address:','zupetcore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Phone Number:','zupetcore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Zupet_Footer_Address');
	});