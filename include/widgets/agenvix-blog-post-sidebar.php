...
Class Provix_Blog_Post_Sidebar_Widget extends WP_Widget {

	public function __construct(){
		parent::__construct('agenvix-latest-posts', 'Agenvix Latest Posts Sidebar', array(
			'description'	=> 'Agenvix latest blog post sidebar'
		));
	}
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '3', 'agenvix-core' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'agenvix-core' );
		$choose_style = ! empty( $instance['choose_style'] ) ? $instance['choose_style'] : esc_html__( 'style_1', 'agenvix-core' );
	?>
		<p>
...
add_action('widgets_init', function(){
	register_widget('Provix_Blog_Post_Sidebar_Widget');
});
