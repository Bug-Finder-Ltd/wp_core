<?php
class Raizen_Footer_Subscriber_2 extends WP_Widget {

    public function __construct() {
        parent::__construct('raizen-footer-subscriber-2', 'Raizen Footer Subscriber 2', array(
			'description'	=> 'Footer subscriber 2 by Raizen'
		));
    }
    ...
    public function form( $instance ) {
        ...
        ?>
			<p><label for="title"><?php esc_html_e( 'Subscribe Form Shortcode:', 'raizencore' );?></label></p>
...
add_action('widgets_init', function(){
	register_widget('Raizen_Footer_Subscriber_2');
});
