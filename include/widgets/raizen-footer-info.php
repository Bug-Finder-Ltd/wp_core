<?php
	...
	class Raizen_Footer_Info  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('raizen_footer_info',esc_html__('Raizen Footer Info', 'raizencore'),array(
				'description' => esc_html__('Raizen Footer Info', 'raizencore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Text Content:','raizencore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Raizen_Footer_Info');
	});