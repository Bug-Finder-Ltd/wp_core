<?php
class Bwall_Footer_Subscriber extends WP_Widget {

    public function __construct() {
        parent::__construct('bwall-footer-subscriber', 'Bwall Footer Subscriber', array(
			'description'	=> 'Footer subscriber by Bwall'
		));
    }
    ...
    public function form( $instance ) {
        ...
        ?>
			<p><label for="title"><?php esc_html_e( 'Title:', 'bwallcore' );?></label></p>
			...
			<p><label for="title"><?php esc_html_e( 'Subscribe Form Shortcode:', 'bwallcore' );?></label></p>
			...
			<p>
				<label for="title"><?php esc_html_e('Description:','bwallcore'); ?></label>
			</p>
...
add_action('widgets_init', function(){
	register_widget('Bwall_Footer_Subscriber');
});
