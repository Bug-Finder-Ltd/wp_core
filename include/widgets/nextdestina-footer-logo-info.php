<?php 
	Class Nextdestina_Logo_Info_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('nextdestina-logo-info-footer', 'Nextdestina Footer Logo Info', array(
				'description'	=> 'Logo Info Widget by Nextdestina'
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Short Description:','nextdestinacore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Nextdestina_Logo_Info_Footer_Widget');
	});