...
Class Latest_Sidebar_Cat_List_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('protine-sidebar-cats-list', 'Protine Sidebar Category List', array(
			'description'	=> 'Protine sidebar category list'
		));
	}
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '5', 'protinecores' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'protinecores' );
	?>	
		<p>
