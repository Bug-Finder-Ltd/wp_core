<?php
	...
	class Raizen_Footer_Address  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('raizen_footer_address',esc_html__('Raizen Footer Address', 'raizencore'),array(
				'description' => esc_html__('Raizen Footer Address', 'raizencore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Address:','raizencore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Email Address:','raizencore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Phone Number:','raizencore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Raizen_Footer_Address');
	});