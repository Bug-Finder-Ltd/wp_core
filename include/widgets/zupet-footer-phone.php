<?php
	...
	class Zupet_Footer_Phone  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('zupet_footer_phone',esc_html__('Zupet Footer Phone', 'zupetcore'),array(
				'description' => esc_html__('Zupet Footer Phone', 'zupetcore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="Phone 1"><?php esc_html_e('Phone Number 1:','zupetcore'); ?></label>
			</p>
			...
			<p>
				<label for="Phone 2"><?php esc_html_e('Phone Number 2:','zupetcore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Zupet_Footer_Phone');
	});