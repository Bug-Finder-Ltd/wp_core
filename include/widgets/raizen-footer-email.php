<?php
	...
	class Raizen_Footer_Email  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('raizen_footer_email',esc_html__('Raizen Footer Email', 'raizencore'),array(
				'description' => esc_html__('Raizen Footer Email', 'raizencore'),
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Raizen_Footer_Email');
	});