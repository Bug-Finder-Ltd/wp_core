<?php 
	Class Raizen_Latest_Posts_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('raizen-latest-posts-footer', 'Raizen Footer Posts', array(
				'description'	=> 'Latest Post Widget by Raizen'
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Raizen_Latest_Posts_Footer_Widget');
	});