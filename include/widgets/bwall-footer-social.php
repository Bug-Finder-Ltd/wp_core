<?php 
	Class Bwall_Footer_Social_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('bwall-footer-social', 'Bwall Footer Social', array(
				'description'	=> 'Footer Social Widget by Bwall'
			));
		}
                ...
                <div class="media-content">
                    <ul>
						...
						<?php if( !empty($bwall_twitter) ): ?>
							<li><a href="<?php print esc_url($bwall_twitter); ?>"><i class="icon-twiter"></i></a></li>
						<?php endif; ?>
						<?php if( !empty($bwall_linkedin) ): ?>
							<li><a href="<?php print esc_url($bwall_linkedin); ?>"><i class="fa-brands fa-linkedin-in"></i></a></li>
						<?php endif; ?>
						<?php if( !empty($bwall_instagram) ): ?>
							<li><a href="<?php print esc_url($bwall_instagram); ?>"><i class="fa-brands fa-instagram"></i></a></li>
						<?php endif; ?>
					</ul>
                </div>
						</div>
	...
	add_action('widgets_init', function(){
		register_widget('Bwall_Footer_Social_Widget');
	});