<?php 
	Class Protine_Latest_Posts_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('protine-latest-posts-footer', 'Protine Footer Posts', array(
				'description'	=> 'Latest Post Widget by Protine'
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Protine_Latest_Posts_Footer_Widget');
	});