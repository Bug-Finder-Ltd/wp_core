...
Class Latest_Sidebar_Cat_List_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('zupet-sidebar-cats-list', 'Zupet Sidebar Category List', array(
			'description'	=> 'Zupet sidebar category list'
		));
	}
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '5', 'zupetcores' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'zupetcores' );
	?>	
		<p>
