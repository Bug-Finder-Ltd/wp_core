<?php
class Protine_Footer_Subscriber_2 extends WP_Widget {

    public function __construct() {
        parent::__construct('protine-footer-subscriber-2', 'Protine Footer Subscriber 2', array(
			'description'	=> 'Footer subscriber 2 by Protine'
		));
    }
    ...
    public function form( $instance ) {
        ...
        ?>
			<p><label for="title"><?php esc_html_e( 'Subscribe Form Shortcode:', 'protinecore' );?></label></p>
...
add_action('widgets_init', function(){
	register_widget('Protine_Footer_Subscriber_2');
});
