<?php
	...
	class Provix_Footer_Email  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('provix_footer_email',esc_html__('Provix Footer Email', 'agenvix-core'),array(
				'description' => esc_html__('Provix Footer Email', 'agenvix-core'),
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Provix_Footer_Email');
	});