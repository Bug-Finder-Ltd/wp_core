<?php
	...
	class Bwall_Footer_Address  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('bwall_footer_address',esc_html__('Bwall Footer Address', 'bwallcore'),array(
				'description' => esc_html__('Bwall Footer Address', 'bwallcore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Address:','bwallcore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Email Address:','bwallcore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Phone Number:','bwallcore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Bwall_Footer_Address');
	});