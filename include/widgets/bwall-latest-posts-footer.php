<?php 
	Class Bwall_Latest_Posts_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('bwall-latest-posts-footer', 'Bwall Footer Posts', array(
				'description'	=> 'Latest Post Widget by Bwall'
			));
		}
	...
	add_action('widgets_init', function(){
		register_widget('Bwall_Latest_Posts_Footer_Widget');
	});