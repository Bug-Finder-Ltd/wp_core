...
Class Latest_Sidebar_Cat_List_Widget extends WP_Widget{
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '5', 'provixcores' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'provixcores' );
	?>	
		<p>
