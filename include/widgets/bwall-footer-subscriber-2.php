<?php
class Bwall_Footer_Subscriber_2 extends WP_Widget {

    public function __construct() {
        parent::__construct('bwall-footer-subscriber-2', 'Bwall Footer Subscriber 2', array(
			'description'	=> 'Footer subscriber 2 by Bwall'
		));
    }
...
add_action('widgets_init', function(){
	register_widget('Bwall_Footer_Subscriber_2');
});
