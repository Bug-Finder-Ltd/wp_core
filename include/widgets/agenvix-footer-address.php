<?php
	...
	class Provix_Footer_Address  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('provix_footer_address',esc_html__('Provix Footer Address', 'agenvix-core'),array(
				'description' => esc_html__('Provix Footer Address', 'agenvix-core'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Address:','agenvix-core'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Email Address:','agenvix-core'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Phone Number:','agenvix-core'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Provix_Footer_Address');
	});