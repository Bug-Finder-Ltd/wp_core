<?php
	...
	class Zupet_Footer_Info  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('zupet_footer_info',esc_html__('Zupet Footer Info', 'zupetcore'),array(
				'description' => esc_html__('Zupet Footer Info', 'zupetcore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Text Content:','zupetcore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Zupet_Footer_Info');
	});