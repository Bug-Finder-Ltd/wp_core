<?php
	...
	class Raizen_Footer_Phone  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('raizen_footer_phone',esc_html__('Raizen Footer Phone', 'raizencore'),array(
				'description' => esc_html__('Raizen Footer Phone', 'raizencore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="Phone 1"><?php esc_html_e('Phone Number 1:','raizencore'); ?></label>
			</p>
			...
			<p>
				<label for="Phone 2"><?php esc_html_e('Phone Number 2:','raizencore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Raizen_Footer_Phone');
	});