<?php
class Zupet_Footer_Subscriber extends WP_Widget {

    public function __construct() {
        parent::__construct('zupet-footer-subscriber', 'Zupet Footer Subscriber', array(
			'description'	=> 'Footer subscriber by Zupet'
		));
    }
    ...
    public function form( $instance ) {
        ...
        ?>
			<p><label for="title"><?php esc_html_e( 'Title:', 'zupetcore' );?></label></p>
			...
			<p>
				<label for="title"><?php esc_html_e('Description:','zupetcore'); ?></label>
			</p>
...
add_action('widgets_init', function(){
	register_widget('Zupet_Footer_Subscriber');
});
