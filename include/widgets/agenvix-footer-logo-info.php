<?php 
	Class Provix_Logo_Info_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('provix-logo-info-footer', 'Provix Footer Logo Info', array(
				'description'	=> 'Logo Info Widget by Provix'
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Short Description:','agenvix-core'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Provix_Logo_Info_Footer_Widget');
	});