<?php
	...
	class Provix_Footer_Phone  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('provix_footer_phone',esc_html__('Provix Footer Phone', 'agenvix-core'),array(
				'description' => esc_html__('Provix Footer Phone', 'agenvix-core'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="Phone 1"><?php esc_html_e('Phone Number 1:','agenvix-core'); ?></label>
			</p>
			...
			<p>
				<label for="Phone 2"><?php esc_html_e('Phone Number 2:','agenvix-core'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Provix_Footer_Phone');
	});