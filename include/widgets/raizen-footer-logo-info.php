<?php 
	Class Raizen_Logo_Info_Footer_Widget extends WP_Widget{

		public function __construct(){
			parent::__construct('raizen-logo-info-footer', 'Raizen Footer Logo Info', array(
				'description'	=> 'Logo Info Widget by Raizen'
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Short Description:','raizencore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Raizen_Logo_Info_Footer_Widget');
	});