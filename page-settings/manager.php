<?php
namespace NextdestinaCore\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'nextdestinacore' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'nextdestinacore' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'nextdestinacore' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'nextdestinacore' ),
			]
		);
