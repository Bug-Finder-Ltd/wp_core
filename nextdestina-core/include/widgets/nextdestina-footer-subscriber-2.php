<?php
class Nextdestina_Footer_Subscriber_2 extends WP_Widget {

    public function __construct() {
        parent::__construct('nextdestina-footer-subscriber-2', 'Nextdestina Footer Subscriber 2', array(
			'description'	=> 'Footer subscriber 2 by Nextdestina'
		));
    }
...
add_action('widgets_init', function(){
	register_widget('Nextdestina_Footer_Subscriber_2');
});
