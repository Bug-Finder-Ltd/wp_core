<?php
	...
	class Nextdestina_Footer_Info  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('nextdestina_footer_info',esc_html__('Nextdestina Footer Info', 'nextdestinacore'),array(
				'description' => esc_html__('Nextdestina Footer Info', 'nextdestinacore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Text Content:','nextdestinacore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Nextdestina_Footer_Info');
	});