<?php
	...
	class Nextdestina_Footer_Phone  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('nextdestina_footer_phone',esc_html__('Nextdestina Footer Phone', 'nextdestinacore'),array(
				'description' => esc_html__('Nextdestina Footer Phone', 'nextdestinacore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="Phone 1"><?php esc_html_e('Phone Number 1:','nextdestinacore'); ?></label>
			</p>
			...
			<p>
				<label for="Phone 2"><?php esc_html_e('Phone Number 2:','nextdestinacore'); ?></label>
			</p>
	...
	add_action('widgets_init', function(){
		register_widget('Nextdestina_Footer_Phone');
	});